...
// Here we use PowerSettingsNewIcon from Material UI v5 as base
export default function ConnectionButton({ status, handleClick }: ConnectionButtonProps): JSX.Element {
  return (
    <button
      type="button"
      className={`connection-button${status === ConnectionStatus.CONNECTED ? ' connected' : ''}`}
      onClick={handleClick}
    >
